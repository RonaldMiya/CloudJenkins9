...
public class EmployeeDAOTest {
	...
	@Test 
	public void findPersonalizado () {
		
		try {
			
			Employee emp = employeeDAO.findPersonalizado("Ronad", "Miya", 19);
			Assert.assertNotNull(emp);
			
			Assert.assertEquals("Ronald", emp.getFirstname());
			Assert.assertEquals("Miya", emp.getLastname());
 ...
 */
	...
	public void testCreateEmployee() {
		...
		String LOGIN = "goku" + (int) (Math.random() * 100);
		//logger.info(LOGIN);
		String PWD = "1233";
		String FIRSTNAME = "Goku";
		String LASTNAME = "Kakarot";
		int SALARY = 3000;
		int DEPT_ID = 14;
